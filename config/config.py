...
SNOWBALL_SENTENCE_CAP = 1000 # how many text segments to consider
SNOWBALL_LR_MAX_WINDOW = 5 # maximum number of tokens in left/right contexts
SNOWBALL_LEFT_CTX_WEIGHT = 0.7#0.2 # weight for left context
SNOWBALL_MIDDLE_CTX_WEIGHT = 0#0.6 # weight for middle context
SNOWBALL_RIGHT_CTX_WEIGHT = 0.3#0.2 # weight for right context
SNOWBALL_NUM_ITERATIONS = 5 # number of iterations to perform
SNOWBALL_MIN_PATTERN_SUPPORT = 1 # minimum number of patterns per cluster
SNOWBALL_MIN_TUPLE_CONFIDENCE = 0.05#0.8 # minimum acceptable tuple confidence
SNOWBALL_MIN_PATTERN_SIMILARITY = 0.05#0.6 # minimum degree of match for patterns
